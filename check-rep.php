...
?>
  	...
  	<div class="mainbar">
	    ...
	    <!-- Page heading -->
	    <div class="page-head">
	      <h2 class="pull-left">Check Receipt</h2>
            ...
            <div class="col-md-6">
              ...
              <div class="widget">
                ...
                <div class="widget-head">
                  <div class="pull-left">Check Receipt</div>
                  <div class="clearfix"></div>
                </div>
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <!-- Form starts.  -->
                    <form class="form-horizontal" role="form" method="post" action="receipt-status.php" onsubmit="return valid_details();">
                              
                                <div class="form-group">
                                  <label class="col-lg-4 control-label">Enter Receipt Id</label>
                                  <div class="col-lg-8">
                                    <input type="text" class="form-control" name="adno" id="adno" placeholder="Receipt Id">
                                  </div>
                                </div>
				...
				<div class="widget-foot">
				  ...
				  {
				  echo "<p style='color:red;font-weight:bold;text-align:center;font-size:14px;'>Invalid Receipt Id</p>";
				  }
				  ?>
