...
{
$new_ayear=mysql_real_escape_string(trim($_POST['ayear']));
if($new_ayear=="")
{
...
$sql_search='select * from academicyears where ayear_name = ?';
$exe_search_query=& $db->query($sql_search, $new_ayear);
$search_row=$exe_search_query->numRows();
if($search_row==1)
{
echo '<script> alert("Academic Year Already Existing") </script>';
}
else
{
$table_name='academicyears';
$fields_values=array(
		'ayear_name' =>$new_ayear
);
$exe_query= $db->autoExecute($table_name, $fields_values, DB_AUTOQUERY_INSERT);
if($exe_query)
{
$id=mysql_insert_id();
$ayear_id=array('ayear_id' =>"AYID".$id);
$exe_query2= $db->autoExecute($table_name, $ayear_id, DB_AUTOQUERY_UPDATE, "aid=$id");
}
if($exe_query2)
{
...
return false;
	...
	function delfile()
	{
	var yes=confirm("Are you sure want to delete this academic year ?");
	if(!yes)
	{
	return false;
	}
	...
	{
	window.location='ayear_delete.php';
	return true;
	}
	}
</script>
...
?>
  	...
  	<div class="mainbar">
	    ...
	    <!-- Page heading -->
	    <div class="page-head">
	      <h2 class="pull-left">Adding Academic Year</h2>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="widget">
                ...
                <div class="widget-head">
                  <div class="pull-left">Add Academic Year</div>
                  <div class="clearfix"></div>
                </div>
                  ...
                  <div class="padd">
                    ...
                    <form class="form-horizontal" role="form" method="post" action="" onsubmit="return valid_details();">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <input type="text" class="form-control" name="ayear" id="ayear" placeholder="Add Academic Year">
                                  </div>
                                </div>
			...
			<div>
                ...
                <div class="widget-head">
                  <div class="pull-left">Existing Academic Years</div> 
                  <div class="clearfix"></div>
                </div>
                  ...
                  <div class="widget-content">
					...
					echo "<div class='alert alert-danger'>
                      Still Now No Academic Year Added
                    </div>";
					}
					else
					{
                    ...
                    <a href='ayear_edit.php?Id=$eyears[1]' title='Edit'><button class='btn btn-xs btn-warning'><i class='fa fa-pencil'></i></button></a>
                    <a href='ayear_delete.php?Id=$eyears[1]' onclick='return delfile();' title='Delete'><button class='btn btn-xs btn-danger'><i class='fa fa-times'></i></button></a>
