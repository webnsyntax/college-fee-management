...
{
header('Location:search.php?msg=Invalid');
}
}
}
?>
                      ...
                      <tbody>
						...
						echo "<tr>
                          ...
                          <td>
                              ...
                              <a href='student-view.php?Id=$admin_no' title='View'><button class='btn btn-xs btn-success'><i class='fa fa-check'></i> </button></a>
                              <a href='student-edit.php?Id=$admin_no' title='Edit'><button class='btn btn-xs btn-warning'><i class='fa fa-pencil'></i> </button></a>
