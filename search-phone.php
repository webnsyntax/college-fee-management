...
else if(!document.getElementById('phone').value.match(con))
{
              ...
              <div class="widget">
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <!-- Form starts.  -->
                    <form class="form-horizontal" role="form" method="post" action="student-details1.php" onsubmit="return valid_details();">
                              
                                <div class="form-group">
                                  <label class="col-lg-4 control-label">Enter Phone Number</label>
                                  <div class="col-lg-8">
