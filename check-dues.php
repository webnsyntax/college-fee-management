...
?>
  	...
  	<div class="mainbar">
	    ...
	    <!-- Page heading -->
	    <div class="page-head">
	      <h2 class="pull-left">Check Due Details</h2>
        ...
        <div class="container">
            ...
            <div class="col-md-8">
              ...
              <div class="widget">
                ...
                <div class="widget-head">
                  <div class="pull-left">Check Due Details</div>
                  <div class="clearfix"></div>
                </div>
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <!-- Form starts.  -->
                     <form class="form-horizontal" name="myform" role="form" method="post" enctype="multipart/form-data" action="">
			...
			if(isset($_POST['sub']) && $_POST['sub']=="Search")
			{
				...
				$db->setFetchMode(DB_FETCHMODE_ORDERED);
							...
							if($edlevel==1 && $tbranch==1 && $tyear==1 && $ayear==1)
							{
							$sql_search='select * from concessions where due > 0 order by date asc';
							$exe_search_query=& $db->query($sql_search);
							}
							else
							{
							$sql_search="select * from concessions where due > 0";
							
								if($edlevel!=1)
								{
								$sql_search.=" and ed_level = '{$edlevel}'";
								}
								if($tbranch!=1)
								{
			...
			<div class='widget'>
                ...
                <div class='widget-head'>
                  <div class='pull-left'>Due Details</div>
                  ...
                  <div class='widget-content'>
					...
					echo "<div class='alert alert-danger'>
                      No Dues Found As Per Your Search Criteria.
                    </div>";
					}
					else
					{
                      echo "<tbody>";
					  $i=1;
					  while($edues=& $exe_search_query->fetchRow())
					{
                        echo "<tr>
                          <td>$i</td>
                          <td>$edues[1]</td>
                          ...
                          <td>$edues[9]</td>
                          <td>$edues[10]</td>
                          <td><a href='get-details.php?Id=$edues[1]' target='_blank'><button class='btn btn-primary'>Full Details</button></a></td>
                        </tr>";
						$i++;
					}			
                      echo "</tbody>";
