...
$sql='select * from branches where brid = ?';
$exe_query=& $db->query($sql, $branch_id);
...
$update_query="update branches set brname='$new_branch' where brid='{$branch_id}'" ;
...
?>
  	...
  	<div class="mainbar">
	    ...
	    <!-- Page heading -->
	    <div class="page-head">
	      <h2 class="pull-left">Updating Branch</h2>
            ...
            <div class="col-md-6">
              ...
              <div class="widget">
                ...
                <div class="widget-head">
                  <div class="pull-left">Update Branch</div>
                  <div class="clearfix"></div>
                </div>
                  ...
                  <div class="padd">
                    ...
                    <form class="form-horizontal" role="form" method="post" action="" onsubmit="return valid_details();">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <input type="text" class="form-control" name="branch" id="branch" value="<?php echo $data[2]; ?>">
                                  </div>
                                </div>
