...
{
$cphone=mysql_real_escape_string(trim($_POST['cphone']));
$nphone=mysql_real_escape_string(trim($_POST['nphone']));
$db->setFetchMode(DB_FETCHMODE_ORDERED);
$sql_search="select * from admin where user_name = ? and phone = ?";
$search_fields=array($admin, $cphone);
$exe_search=& $db->query($sql_search, $search_fields);
$test_row=$exe_search->numRows();
if($test_row==1)
{
$update_sql="update admin set phone='$nphone' where user_name='{$admin}'";
...
{
echo '<script> alert("Current Phone Number You Entered Is Not Matching..") </script>';
}
}
?>
<!DOCTYPE html>
...
else if(!document.getElementById('cphone').value.match(con))
{
...
else if(!document.getElementById('nphone').value.match(con))
{
alert("Please Enter Valid 10 Digit Phone Number");
document.getElementById('nphone').focus();
return false;
}
if(document.getElementById('nrphone').value=="")
{
alert("Please Re-Enter New Phone Number");
document.getElementById('nrphone').focus();
return false;
}
if(document.getElementById('nphone').value!=document.getElementById('nrphone').value)
{
alert("New Phone Number And Retype New Phone Number Not Matching");
document.getElementById('nrphone').focus();
return false;
}
}
        ...
        <div class="container">
            ...
            <div class="widget">
                ...
                <div class="widget-head">
                  <div class="pull-left">Change Phone Number</div>
                  <div class="clearfix"></div>
                </div>
                  ...
                  <div class="padd">
                    ...
                    <form class="form-horizontal" role="form" method="post" action="" onsubmit="return valid_details();">
                                ...
                                <div class="form-group">
                                  <label class="col-lg-4 control-label">Current Phone Number</label>
                                  <div class="col-lg-8">
                                    <input type="text" class="form-control" name="cphone" id="cphone" placeholder="Current Phone Number">
                                  </div>
                                </div>
								<div class="form-group">
                                  <label class="col-lg-4 control-label">New Phone Number</label>
                                  <div class="col-lg-8">
                                    <input type="text" class="form-control" name="nphone" id="nphone" placeholder="New Phone Number">
                                  </div>
                                </div>
								<div class="form-group">
                                  <label class="col-lg-4 control-label">Retype New Phone Number</label>
                                  <div class="col-lg-8">
                                    <input type="text" class="form-control" name="nrphone" id="nrphone" placeholder="Retype New Phone Number">
                                  </div>
                                </div>
