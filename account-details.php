...
{
$admin_no=mysql_real_escape_string(trim($_POST['adno']));
...
if($test_row==0)
{
header('Location:make-payment.php?msg=Invalid');
}
else
{
...
else if(!document.getElementById('amount').value.match(con))
{
alert("Please Enter Valid Amount Value");
document.getElementById('amount').focus();
return false;
...
{
var yes=confirm("Are you sure want to proceed?");
if(!yes)
{
location.reload();
return false;
        ...
        <div class="container">
            ...
            <div class="col-md-12">
			   ...
			   <div class="widget">
                ...
                <div class="widget-head">
                  <div class="pull-left">Pay Here...!</div>
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <!-- Form starts.  -->
                    <form class="form-horizontal" role="form" method="post" action="pay.php" onsubmit="return valid_details();">
								...
								<div class="form-group">
                                  ...
                                  <div class="col-lg-10">
                                    <input type="text" class="form-control" name="ed_level" id="ed_level" value="<?php echo $student_data[5];?>" readonly>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-10">
                                    <input type="text" class="form-control" name="branch" id="branch" value="<?php echo $student_data[7];?>" readonly>
                                  </div>
                                </div>                   
								...
								<div class="form-group">
                                  ...
                                  <div class="col-lg-10">
                                    <select class="form-control" name="year" id="year">
									  ...
									  <?php
									  if($student_data[5]=="Intermediate")
									  {
									  ?>
                                ...
                                <div class="form-group">
                                  <div class="col-lg-offset-2 col-lg-9">
                                    <input type="submit" class="btn btn-success" name="sub" value="Pay">
                                  </div>
                                </div>
                    </form>
                  </div>
