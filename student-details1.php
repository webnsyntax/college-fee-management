...
if($phone=="")
{
header('Location:search-phone.php');
}
else
{
$db->setFetchMode(DB_FETCHMODE_ORDERED);
$sql='select * from students where phone1 = ?';
$exe_query=& $db->query($sql, $phone);
...
{
header('Location:search-phone.php?msg=Invalid');
}
}
}
?>
                      ...
                      <tbody>
						...
						echo "<tr>
                          ...
                          <td>
                              ...
                              <a href='student-view.php?Id=$data[1]' title='View'><button class='btn btn-xs btn-success'><i class='fa fa-check'></i> </button></a>
                              <a href='student-edit.php?Id=$data[1]' title='Edit'><button class='btn btn-xs btn-warning'><i class='fa fa-pencil'></i> </button></a>
