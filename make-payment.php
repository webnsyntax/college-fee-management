...
?>
  	...
  	<div class="mainbar">
	    ...
	    <!-- Page heading -->
	    <div class="page-head">
	      <h2 class="pull-left">Make Payment</h2>
            ...
            <div class="col-md-6">
              ...
              <div class="widget">
                ...
                <div class="widget-head">
                  <div class="pull-left">Make Payment</div>
                  <div class="clearfix"></div>
                </div>
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <!-- Form starts.  -->
                    <form class="form-horizontal" role="form" method="post" action="account-details.php" onsubmit="return valid_details();">
