...
$sql='select * from academicyears where ayear_id = ?';
$exe_query=& $db->query($sql, $ayear_id);
...
{
$new_year=mysql_real_escape_string(trim($_POST['ayear']));
$update_query="update academicyears set ayear_name='$new_year' where ayear_id='{$ayear_id}'" ;
$exe_query2=& $db->query($update_query);
if($exe_query2)
{
include("add-academic.php");
echo '<script> alert("Academic Year Updated Successfully") </script>';
                  ...
                  <div class="padd">
                    ...
                    <form class="form-horizontal" role="form" method="post" action="" onsubmit="return valid_details();">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <input type="text" class="form-control" name="ayear" id="ayear" value="<?php echo $data[2]; ?>">
                                  </div>
                                </div>
