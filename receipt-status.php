...
{
$receipt_id=mysql_real_escape_string(trim($_POST['adno']));
$db->setFetchMode(DB_FETCHMODE_ORDERED);
$pay_sql='select * from payments where rid = ?';
$exe_pay_query=& $db->query($pay_sql, $receipt_id);
$test_row=$exe_pay_query->numRows();
if($test_row!=1)
{
header('Location:check-rep.php?msg=Invalid');
}
else
{
$pay_details=& $exe_pay_query->fetchRow();
$admin_no=$pay_details[2];
$db->setFetchMode(DB_FETCHMODE_ORDERED);
$student_sql='select * from students where ad_no = ?';
$exe_student_query=& $db->query($student_sql, $admin_no);
$student_row=$exe_student_query->numRows();
if($student_row!=1)
{
...
{
$student_details=& $exe_student_query->fetchRow();
}
}
}
else
                  ...
                  <div class="padd invoice">
                    ...
                    <div class="row">
						...
						<div class="support-contact">
                                ...
                                <p><i class="fa fa-user"></i> Name<strong>:</strong><?php echo $student_details[3]; ?></p>
                                
                                <p><i class="fa fa-phone"></i> Phone<strong>:</strong><?php echo $student_details[8]; ?></p>
                                                          
                                <p><i class="fa fa-home"></i> Address<strong>:</strong><?php echo $student_details[10]; ?></p>
                                <br>
                             </div>
						</div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                       ...
                       <tbody>
                            ...
                            <tr>
                              <td>1</td>
                              <td><?php echo $pay_details[1]; ?></td>
							  <td><?php echo $pay_details[2]; ?></td>
                              <td><?php echo $pay_details[3]; ?></td>
                              <td><?php echo $pay_details[4]; ?></td>
                              <td><?php echo $pay_details[5]; ?></td>
                              <td><?php echo $pay_details[6]; ?></td>
                            </tr>
							</tbody>

                        </table>
										<hr/>
					<input type="button" class="btn btn-primary pull-right" id="printpagebutton" value="Print" onclick="printpage();">
                      </div>
