...
?>
  	...
  	<div class="mainbar">
	    ...
	    <!-- Page heading -->
	    <div class="page-head">
	      <h2 class="pull-left">Get Fee Status</h2>
            ...
            <div class="col-md-6">
              ...
              <div class="widget">
                ...
                <div class="widget-head">
                  <div class="pull-left">Get Fee Status</div>
                  <div class="clearfix"></div>
                </div>
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <!-- Form starts.  -->
                    <form class="form-horizontal" role="form" method="post" action="fee-details.php" onsubmit="return valid_details();">
                                ...
                                <div class="form-group">
                                  <div class="col-lg-offset-6 col-lg-9">
                                    <input type="submit" class="btn btn-info" name="sub" value="Get Details">
                                  </div>
                                </div>
                    </form>
                  </div>
				...
				<div class="widget-foot">
				  ...
				  {
				  echo "<p style='color:red;font-weight:bold;text-align:center;font-size:14px;'>Invalid Admission Number</p>";
				  }
				  ?>
